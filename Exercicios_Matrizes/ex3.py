...
if matrizA_Linha == matrizB_Linha and matrizA_Coluna == matrizB_Coluna:
    matriz_resultado = np.subtract(MatrizA, MatrizB)

    for r in matriz_resultado:
        print(r)

else:
    print('As matrizes não podem ser subtraidas. Verifique suas dimensões.')
